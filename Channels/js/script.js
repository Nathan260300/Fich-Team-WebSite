...
console.log("%cChaînes Soutenues - FICH Team", "background: #282c34; color: #61afef; padding: .5em 1em; border-radius: 5px; font-weight: bold;");
...
console.log("%chttps://fich-team.netlify.app/channels", "background: #282c34; color: #e06c75; padding: .5em 1em; border-radius: 5px; font-weight: bold;");
